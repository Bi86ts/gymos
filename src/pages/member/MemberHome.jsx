  ...
  return (
    <div className="space-y-8 pb-8 animate-in fade-in duration-500">
      ...
      <div className="flex justify-between items-center gap-2">
        {/* Coach Presence */}
        <div className="flex items-center gap-3 bg-surface-container-low border border-primary/20 px-3 py-1.5 rounded-full flex-1 max-w-[240px]">
          <div className="relative shrink-0">
            ...
            <div className="absolute bottom-0 right-0 w-2 h-2 bg-primary rounded-full border border-surface shadow-[0_0_5px_rgba(205,255,24,0.5)]"></div>
          </div>
      ...
      {/* Daily Status */}
      {isRestDay ? (
        <section className="bg-surface-container rounded-xl p-6 relative overflow-hidden border border-outline-variant/10 shadow-lg">
        ...
        <section className="bg-gradient-to-br from-surface-container-low to-surface-container p-6 rounded-xl relative overflow-hidden group shadow-lg border border-primary/20">
        ...
        <section className="bg-surface-container-low rounded-xl p-6 relative overflow-hidden border border-primary/20 shadow-[0_0_30px_rgba(205,255,24,0.05)]">
          <div className="flex items-center gap-4">
            <div className="relative">
              <span className="material-symbols-outlined text-5xl text-primary drop-shadow-[0_0_10px_rgba(205,255,24,0.5)]" style={{fontVariationSettings: "'FILL' 1"}}>check_circle</span>
        ...
        <section className="relative">
          <div className="bg-surface-container rounded-3xl overflow-hidden border border-outline-variant/10 shadow-2xl">
            <div className="h-56 relative bg-gradient-to-br from-surface-container-highest to-surface">
              {/* Optional: Add a background image of the gym here */}
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="bg-surface-container-lowest p-4 rounded-2xl flex flex-col justify-between">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-headline font-black text-on-surface">12.5k lbs</p>
                  </div>
                </div>
                <div className="bg-surface-container-lowest p-4 rounded-2xl flex flex-col justify-between">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-headline font-black text-on-surface">6 Exercises</p>
                  </div>
                </div>
              </div>
              <Link
      ...
      <section className="grid grid-cols-2 gap-4">
        {/* Streak / Momentum */}
        <div className="bg-surface-container rounded-2xl p-5 border border-outline-variant/5 shadow-md relative overflow-hidden group flex flex-col justify-between">
          ...
          <div className="relative z-10 w-full">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[10px] font-bold text-on-surface-variant">12 Days</span>
            </div>
          ...
          <div className="relative z-10 mt-4 border-t border-outline-variant/10 pt-3 flex justify-between items-center">
            ...
            <p className="text-sm font-headline font-black text-on-surface">12 Days</p>
          </div>
        </div>
        
        {/* Consistency */}
        <div className="bg-surface-container rounded-2xl p-5 border border-outline-variant/5 shadow-md flex flex-col justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="relative w-14 h-14 shrink-0">
              <svg className="w-full h-full -rotate-90 transform" viewBox="0 0 100 100">
                ...
                <circle className="text-primary drop-shadow-[0_0_8px_rgba(205,255,24,0.4)]" cx="50" cy="50" fill="transparent" r="40" stroke="currentColor" strokeDasharray="251.2" strokeDashoffset="30.1" strokeLinecap="round" strokeWidth="12" style={{ transition: 'stroke-dashoffset 1s ease-in-out' }}></circle>
              </svg>
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-sm font-headline font-black text-on-surface">88<span className="text-[8px]">%</span></span>
              </div>
            </div>
            <div>
